...
using MaterialManagementProject.Map.Option;
...
namespace MaterialManagementProject.DAL.Context
{
    public class ProjectContext:DbContext
    {
        public ProjectContext()
        {
            Database.Connection.ConnectionString = "Server=DESKTOP-2E73AVS\\SQLEXPRESS;Database=MaterialProject;uid=tk;pwd=123;";
        }
